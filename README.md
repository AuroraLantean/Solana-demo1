# Demo on Solana program(smart contract) and frontend client
...
* An on-chain demo program
* A client that can invoke a program function with arguments of a string, an integer, and an array
...
### Build the on-chain program written in Rust
...
Creating account 8MBmHtJvxpKdYhdw6yPpedp6X6y2U9dCpdYaZJdmwV3A 
Success
```
